 ...
 */
@Configuration
@PropertySources({@PropertySource(value = "classpath:message.properties", ignoreResourceNotFound = false), @PropertySource(value = "classpath:banned-products.properties", ignoreResourceNotFound = false)})
public class WebPropertyConfig {
    ...
    public String getPropertyForCurrentEnv(final String inKey) {
        final String theKey = inKey + "." + StringUtils.upperCase(System.getProperty(WebApplicationConstants.APP_DPL_LVL));
